...
func (c *nodeClient) Request(ctx context.Context, in *LamportMessage, opts ...grpc.CallOption) (*Empty, error) {
...
func (c *nodeClient) Reply(ctx context.Context, in *LamportMessage, opts ...grpc.CallOption) (*Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Empty)
...
func (UnimplementedNodeServer) Request(context.Context, *LamportMessage) (*Empty, error) {
...
func _Node_Request_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NodeServer).Request(ctx, req.(*LamportMessage))
	}
...
func _Node_Reply_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NodeServer).Reply(ctx, req.(*LamportMessage))
	}
	return interceptor(ctx, in, info, handler)
}
